...
def handle_question_menu(chat_id):
    ...
    send_message(
        ...
        "مناسب برای سوال‌های ساده، راهنمایی اولیه و دانستن حق‌وحقوق. پاسخ متنی کوتاه دریافت می‌کنید.\n\n"
        "🔹 پرسش تخصصی (۵۰۰,۰۰۰ تومان)\n"
        "مناسب برای موضوعات پیچیده‌تر که نیاز به بررسی دقیق دارن. می‌تونید مدارک هم ضمیمه کنید.\n\n"
        f"⏱ زمان پاسخ‌دهی: {RESPONSE_TIME_NOTICE}\n\n"
        "کدوم نوع رو نیاز دارید؟",
        keyboard,
    )
...
def handle_document_menu(chat_id):
    ...
    send_message(
        ...
        "🔹 دادخواست: طرح دعوی در دادگاه\n"
        "🔹 شکواییه: طرح شکایت کیفری\n"
        "🔹 اظهارنامه: اعلام رسمی موضعی به طرف مقابل\n"
        "🔹 قرارداد: تنظیم توافقنامه بین طرفین\n"
        "🔹 لایحه حقوقی: دفاع در پرونده‌های حقوقی\n"
        "🔹 لایحه کیفری: دفاع در پرونده‌های کیفری\n\n"
        "کدوم سند رو نیاز دارید؟",
        keyboard,
    )
